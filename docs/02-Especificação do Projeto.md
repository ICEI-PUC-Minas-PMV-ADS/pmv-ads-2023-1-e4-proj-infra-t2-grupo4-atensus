...
|---|-----------|----------|-------------|---------|------------|-----------------------|
| 1 |  Tempo Médio de Resposta- Urgência  | Quanto tempo o sistema de triagem leva para responder uma solicitação de atendimento de emergência | Cálcular o tempo de atendimento de emergência| Cadastro + Tempo de atendimento hospitalar | Tempo de Atendimento (Aplicação) |Eficiência do atendimento
...
![image](https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2023-1-e4-proj-infra-t2-grupo4-atensus/blob/main/docs/img/imagem_2023-03-26_205815374.png)
