...
|---|-----------|----------|-------------|---------|------------|-----------------------|
| 1 |  Tempo Médio de Resposta- Urgência  | Quanto tempo o sistema de triagem leva para responder uma solicitação de atendimento de emergência | Cálcular o tempo de atendimento de emergência| Cadastro + Tempo de atendimento hospitalar | Eficiência do atendimento
