...
|---|-----------|----------|-------------|---------|------------|-----------------------|
| 1 |  Tempo Médio de Resposta- Urgência  | Quanto tempo o sistema de pré triagem leva para responder uma solicitação de atendimento de emergência | Eficiência do atendimento
